// https://imvikaskohli.medium.com/how-to-add-elements-and-remove-elements-in-the-array-create-custom-id-using-firestore-angular-10c728d49439
// https://firebase.google.com/docs/firestore/manage-data/add-data?authuser=0#web-modular-api_12
...
@Component({
    ...
    styleUrl: './array-remove.component.scss'
})
